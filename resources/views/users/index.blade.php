...
<div class="table-responsive">
    <table class="table text-center table-hover border border-gray-800 table-auto">
        ...
        <tbody>
            ...
            <tr>
                <td class="py-1">
                    <img class="rounded-circle ml-5" src="{{ asset($user->photo) }}" style="height: 50px;" height="50" width="50">
                    </img>
                </td>
                <td>
                ...
                <td class="">
                    {!!\DateTime::createFromFormat("Y-m-d H:i:s", date('Y-m-d H:i:s', strtotime($user->created_at)))->format("Y-m-d H:i")  !!}
                </td>
                <td>
